package com.projectTeam.studyaim.model; // 사용자 엔티티 생성 클래스
...
@AllArgsConstructor
// JPA 쓰려면 디폴트 생성자가 필요하므로 @Builder 를 함께 사용하려는 경우에는 @NoArgsConstructor 와 @AllArgsConstructor 를 추가해주는 방식으로 문제 해결
@NoArgsConstructor
