...
public class UserService {
    ...
    private final String clientId = "d9a87ff60b8dbb5c22eaf114ed0f30d4";
    private final String clientSecret = "Ygd1pmN88vehqlCaHtnROsrp507YwTJ8";
    ...
    public String requestPostWithFormData(String contextPath, LoginDto loginDto) {  // contextPath: "/auth/authenticate"
        ...
        String url = "http://ec2-43-200-56-121.ap-northeast-2.compute.amazonaws.com:8080" + contextPath;
        HttpHeaders headers = new HttpHeaders();
