package com.projectTeam.studyaim.configuration;

import com.projectTeam.studyaim.jwt.JwtAccessDeniedHandler;
import com.projectTeam.studyaim.jwt.JwtAuthenticationEntryPoint;
import com.projectTeam.studyaim.jwt.JwtSecurityConfig;
import com.projectTeam.studyaim.jwt.TokenProvider;
import com.projectTeam.studyaim.userService.CustomUserDetailsService;
    ...
    public static class BasicAuthWebSecurityConfigurationAdapter  extends WebSecurityConfigurerAdapter {
        ...
        public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
            auth.inMemoryAuthentication()
                    .withUser("OPENVIDUAPP").password(passwordEncoder().encode("studyaim"))
                    .roles("OPENVIDU");
        }
